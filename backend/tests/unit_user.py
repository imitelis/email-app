...
class UnitTestUser(unittest.TestCase):
    ...
    def test_user_name_too_short(self):
        with self.assertRaisesRegex(
            ValueError, "Full name must be at least 8 characters long."
        ):
            User(
                full_name="Jo",
                email="john@example.com",
    ...
    def test_user_name_too_long(self):
        with self.assertRaisesRegex(
            ValueError, "Full name must be at most 128 characters long."
        ):
            User(
    ...
    def test_email_too_short(self):
        with self.assertRaisesRegex(
            ValueError, "Email must be at least 8 characters long."
        ):
            User(
                full_name="John Doe",
                email="jo@e.co",
    ...
    def test_email_too_long(self):
        with self.assertRaisesRegex(
            ValueError, "Email must be at most 128 characters long."
        ):
            User(
                full_name="John Doe",
    ...
    def test_cellphone_too_short(self):
        with self.assertRaisesRegex(
            ValueError, "Cellphone must be at least 8 characters long."
        ):
            User(
                full_name="John Doe",
                email="john@example.com",
    ...
    def test_cellphone_too_long(self):
        with self.assertRaisesRegex(
            ValueError, "Cellphone must be at most 16 characters long."
        ):
            User(
                full_name="John Doe",
                email="john@example.com",
