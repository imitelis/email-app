...
EmailUserBase = api.model('EmailUserBase', {
...
EmailBase = api.model('EmailBase', {
    ...
    "recipient_folder": fields.Integer(description='Email recipient folder', min_value=0, max_value=4),
})

EmailInputBase = api.model('EmailInputBase', {
...
EmailFolderBase = api.model('EmailUserBase', {
    "recipient_folder": fields.Integer(description='Email recipient folder', min_value=0, max_value=4),
})