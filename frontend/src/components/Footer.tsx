...
const SocialButton = ({ children, label, href, buttonText }: { children: React.ReactNode, label: string, href: string, buttonText: string }) => {
  return (
    <a
      href={href}
      style={{
    ...
    >
      <Typography variant="body1" style={{ marginRight: '8px' }}>{buttonText}</Typography>
      <span
        style={{
